...
import com.sinarkelas.ui.videocallgroup.adapters.UsersAdapter
...
import com.sinarkelas.ui.videocallgroup.videoutil.signOut
...
class OpponentsActivity : BaseActivity() {
    ...
    private fun startCall(isVideoCall: Boolean) {
        ...
        WebRtcSessionManager.WebRtcSessionManager.setCurrentSession(newQbRtcSession)
