...
import com.sinarkelas.ui.videocallgroup.fragment.*
...
import com.sinarkelas.ui.videocallgroup.videoutil.loadUsersByIds
...
class CallActivity : BaseActivity(), IncomeCallFragmentCallbackListener, QBRTCSessionStateCallback<QBRTCSession>,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mainqb)
    }
    ...
    private fun startSuitableFragment(isInComingCall: Boolean) {
        val session = WebRtcSessionManager.WebRtcSessionManager.getCurrentSession()
        if (session != null) {
            if (isInComingCall) {
