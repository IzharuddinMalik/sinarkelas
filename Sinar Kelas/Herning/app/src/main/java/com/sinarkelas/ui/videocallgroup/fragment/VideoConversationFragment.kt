...
import com.sinarkelas.ui.videocallgroup.adapters.OpponentsFromCallAdapter
import com.sinarkelas.ui.videocallgroup.services.CallService
import com.sinarkelas.ui.videocallgroup.videoutils.SharedPrefsHelper
import com.sinarkelas.ui.videocallgroup.videoutils.shortToast
...
class VideoConversationFragment : BaseConversationFragment(), Serializable,
    ...
    override fun configureOutgoingScreen() {
        ...
        allOpponentsTextView.setTextColor(ContextCompat.getColor(context, R.color.whiteColor))
        ringingTextView.setTextColor(ContextCompat.getColor(context, R.color.whiteColor))
    }
    ...
    override fun configureToolbar() {
        ...
        toolbar.setTitleTextColor(ContextCompat.getColor(context, R.color.whiteColor))
        toolbar.setSubtitleTextColor(ContextCompat.getColor(context, R.color.whiteColor))
    }
    ...
    override fun onOpponentsListUpdated(newUsers: java.util.ArrayList<QBUser>) {
    ...
    private fun updateAllOpponentsList(newUsers: java.util.ArrayList<QBUser>) {
    ...
    private fun runUpdateUsersNames(newUsers: java.util.ArrayList<QBUser>) {
