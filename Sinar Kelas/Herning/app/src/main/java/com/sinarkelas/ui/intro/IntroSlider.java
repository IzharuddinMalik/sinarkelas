package com.sinarkelas.ui.intro;
...
import com.sinarkelas.ui.register.PilihanRegister;
import com.sinarkelas.util.PrefManager;
...
public class IntroSlider extends AppCompatActivity {
    ...
    CardView cvDaftarSekarang;
    TextView tvSudahPunyaAkun, tvMasuk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvDaftarSekarang = findViewById(R.id.cvDaftarSekarang);
        ...
        cvDaftarSekarang.setOnClickListener(v -> {
            startActivity(new Intent(this, PilihanRegister.class));
        });
