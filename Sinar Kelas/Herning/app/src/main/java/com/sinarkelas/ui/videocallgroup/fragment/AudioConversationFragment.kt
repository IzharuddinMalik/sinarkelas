...
class AudioConversationFragment : BaseConversationFragment(), CallActivity.OnChangeAudioDevice {
    ...
    override fun configureOutgoingScreen() {
        ...
        outgoingOpponentsRelativeLayout.setBackgroundColor(ContextCompat.getColor(context, R.color.whiteColor))
    ...
    override fun configureToolbar() {
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(context, R.color.whiteColor))
