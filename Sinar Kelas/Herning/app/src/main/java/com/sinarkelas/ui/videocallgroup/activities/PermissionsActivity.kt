...
import com.sinarkelas.ui.videocallgroup.videoutils.longToast
...
class PermissionsActivity : BaseActivity() {
    ...
    private fun checkPermissions() {
        ...
        if (checkOnlyAudio) {
            permissions?.get(1)?.let { checkPermissionAudio(it) }
        } else {
            checkPermissionAudioVideo(permissions as Array<String>)
        }
    }
    ...
    private fun getPermissions(): Array<out String>? {
